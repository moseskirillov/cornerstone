...
def handlers_register(application: Application) -> None:
    ...
    application.add_handler(CallbackQueryHandler(select_district_handler, find_group_callback))
    application.add_handler(CallbackQueryHandler(select_type_handler, r'district_\d+'))
    application.add_handler(CallbackQueryHandler(select_time_handler, r'type_\d+'))
